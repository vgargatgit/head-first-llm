...
- Registered the current chapter set:
...
- Standardized the cream-paper, purple-accented, hand-drawn cartoon visual language.
...
- the generated or browser-facing chapter page;
